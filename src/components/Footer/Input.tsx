  ...
  return (
    <div>
      <div className="flex py-1 w-full">
        <form onSubmit={handleSubmit(sendMail)} className="w-full">
          <input
            type="email"
            name="email"
            autoComplete="off"
            ...
            className="placeholder-white py-2 px-1"
            style={{
              backgroundColor: "#8A7B79",
              opacity: "0.7",
              width: "calc(100% - 50px)",
          ...
          <button
            disabled={load}
            type="submit"
            className="bg-primary px-4 pb-4 pt-3 disabled:bg-red-300"
          >
            {!load ? (
              <svg
                width="16"

...
import { Bold } from "../../Bookings/Globals/index.styles";
import { WrapSection } from "../../Bookings/Date/Date.styles";
import {
  CalendarIcon,
  CardOff,
  CardOffText,
  ...
  Wrap,
  WrapIconAndInfo,
} from "../../Bookings/Congrat/Congrat.styles";

moment.locale("es");
const congrats = ({ route }: { route: string }) => {
  ...
  return (
    <Fragment>
      <SEOUpdate
        ...
        url={`https://evacenter.com/${route}/congrats`}
      />
      <Header showBar />
      <WrapSection>
        <Wrap>

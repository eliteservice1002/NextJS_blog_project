  ...
  return (
    <div>
      ...
      <SEOUpdate
        ...
        url="https://evacenter.com/prevencion-40"
      />
      <Hero
        imgM={require("../../assets/images/prevention-20/hero-sm.png")}
        imgD={require("../../assets/images/prevention-20/hero-lg.png")}
      ...
      >
        <div className="hidden lg:flex">
          {token && <Scheduler token={token} route="prevencion-40" />}
        </div>
      </Hero>
      ...
      <Stories
        opinions={[
          {
            img: "/img/Discover/opinion1-40-v2.png",
          ...
          {
            img: "/img/Discover/opinion2-40-v2.png",
            title: "“Cuida de ti y de quienes amas”",
            opinion:
              "El cáncer no discrimina la edad. Por eso cuando cuido la salud de mis senos, vengo con mi hija.",
        ...
        videos={[
          ...
          {
            img: "/img/Discover/stories2-40-sm.png",
            video:
              "https://798944760764-files.s3.amazonaws.com/videos/05_final_ads_familia.mp4",
          },
        ]}
      />
      <TakecareBanner />
